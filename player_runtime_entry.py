...
install_command_surface_v3(main)
...
async def on_startup(dp):
    ...
    install_role_distribution_notice(main); install_lobby_callback_cutover(main); logging.info("FINAL UI AUTHORITY ACTIVE")
if __name__=="__main__": main.executor.start_polling(main.dp,skip_updates=True,on_startup=on_startup)
